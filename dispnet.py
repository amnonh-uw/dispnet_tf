...
class DispNet:
    def __init__(self):
        ...
        self.loss6 = self.l1loss(self.pr6, self.disp, self.loss_weights[5], 6)
        ...
        self.loss5 = self.l1loss(self.pr5, self.disp, self.loss_weights[4], 5)
        ...
        self.loss4 = self.l1loss(self.pr4, self.disp, self.loss_weights[3], 4)
        ...
        self.loss3 = self.l1loss(self.pr3, self.disp, self.loss_weights[2], 3)
        ...
        self.loss2 = self.l1loss(self.pr2, self.disp, self.loss_weights[1], 2)
        ...
        self.loss1 = self.l1loss(self.pr1, self.disp, self.loss_weights[0], 1)

        self.loss_decay = self.weight_decay * tf.losses.get_regularization_loss()
        tf.summary.scalar("loss_decay", self.loss_decay)

        self.loss = self.loss1 + self.loss2 + self.loss3 + self.loss4 + self.loss5 + self.loss6 + self.loss_decay
